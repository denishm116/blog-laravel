...
<textarea class="form-control" name="short_description" id="short_description" value="">{{$article->short_description ?? ""}}</textarea>

<label for="" style="margin-top: 30px">Полное описание</label>
<textarea class="form-control" name="description" value="" id="description" required>{{$article->description ?? " "}}</textarea>
@isset($article->image)
    <p>
